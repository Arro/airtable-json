...
test.beforeEach(async(t) => {
  ...
  const a_ids =  ["reca9IDlX0gvu32ml", "recgh3XeMcdmX8uPj", "reczBZBWZG06DOsCO", "recXvnMcZKmxyBtUi"]
...
test("correctly joins tables for first populate", async(t) => {
  t.is(artists_response.records[0].fields.Name, t.context.songs[2].Artists[0].Name)
  t.is(artists_response.records[1].fields.Name, t.context.songs[1].Artists[0].Name)
  t.is(artists_response.records[2].fields.Name, t.context.songs[0].Artists[0].Name)
  t.is(artists_response.records[3].fields.Name, t.context.songs[2].Artists[1].Name)
})

test("correctly joins tables for second populate", async(t) => {
  t.is(remixers_response.records[0].fields.Name, t.context.songs[0].Remixers[0].Name)
})
